...
public class WordCounter {
    ...
    public static Map<String, Integer> calculateWord() {
        ...
        // Tüm karakterleri küçük harfe çevir, noktalama işaretlerini temizle
        text = text.toLowerCase().replaceAll("[^a-zA-ZçğıöşüÇĞİÖŞÜ0-9\\s]", " ");

        String[] words = text.split("\\s+"); // Bir veya daha fazla boşluğa göre böl
